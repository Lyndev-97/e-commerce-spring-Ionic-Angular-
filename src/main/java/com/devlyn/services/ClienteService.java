...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		repo.deleteById(id);
			...
			throw new DataIntegrityException("Não é possível excluir porque não vai mano");
		}
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDTO) {
		Cliente cl = new Cliente(null, objDTO.getNome(), objDTO.getEmail(), objDTO.getCpfOuCnpj(), TipoCliente.toEnum(objDTO.getTipo()));
